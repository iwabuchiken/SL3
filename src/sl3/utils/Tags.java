...
public class Tags {
	...
	public static enum DialogTags {
		...
		DLG_SAVE_PUR_HISTORY_OK, 
		
		ACTV_TAB_OPT_DROP_TABLE_ADMIN, 
		
		DLG_POST_ITEMS_OK, 
		DLG_POST_STORES_OK, 
		DLG_POST_GENRES_OK, 
		DLG_POST_SIS_OK, ACTV_TAB2_DLG_LISTS, DLG_CLEAR_SELECTIONS_TAB2, DLG_TAB2_TAB2_SORT_LIST, ACTV_TAB_OPT_UPLOAD_DB,
	...
	public static enum ButtonTags {
		...
		ITEMLIST_TABS_IB_UP, 
		ITEMLIST_TABS_IB_DOWN, ACTV_SHOWLOG_IB_BACK, ACTV_SHOWLOG_IB_TOP, ACTV_SHOWLOG_IB_BOTTOM, ACTV_SHOWLOG_IB_DOWN, ACTV_SHOWLOG_IB_UP,
